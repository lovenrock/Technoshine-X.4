    ...
    if(!preg_match('/^[a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.([a-zA-Z]{2,4})$/', $email))
	 {
	  ...
	  if($check==1)	
	  {
         ...
         //storing data for nethunt   
            
           $netquery1=mysql_query("select * from nethunt_users where email='$email'"); 
           $netquery2=mysql_num_rows($netquery1);
           
           if($netquery2!=1)
           {
            $netquery2=mysql_query("insert into nethunt_users values('$fullname','$reg','$email','1','')");
           } 
         ...
         header('location: http://cadnitd.co.in/nethunt/nethunt.php');  
         exit(0);
	     }
	     else
		 {
...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  <div id="techno">
  <h1 style="font-size:60px;font-weight:900;margin-top:20px;margin-left:490px;">NetHunt Login</h1>
  </div>         
