...
if($level==20)
{
$querry = mysql_query("select * from questions where level_no = '20'");
...
<p style="color:white;font-size:24px;"><img src='<?php echo $question; ?>' width="400" height="300" /></p>
